class Api::ReservationsController < ApplicationController
  ...
  def create
    ...
    @car = Car.find_by(make: params[:reservation][:car][:make], model: params[:reservation][:car][:model], year: params[:reservation][:car][:year], daily_rate: params[:reservation][:car][:daily_rate], weekly_discount: params[:reservation][:car][:weekly_discount], monthly_discount: params[:reservation][:car][:monthly_discount], img: params[:reservation][:car][:img], description: params[:reservation][:car][:description] )
